...
const copyFiles = (distFolder, files) => {
    ...
    for (const file of files) {
        fs_1.copyFileSync(`${currentPath}/${file}`, `${currentPath}/${distFolder}/${file}`);
...
const cleanPackageJson = (distFolder, main, removeDeps, removeScripts) => {
    ...
    try {
        fs_1.writeFileSync(path_1.join(currentPath, `${distFolder}`, 'package.json'), JSON.stringify(pkg, null, 2));
